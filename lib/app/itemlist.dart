...
class ItemListState extends State<ItemList> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      Text(item.name, style: itemInfoTheme.textTheme.bodyMedium),
                      Text(item.nickName ?? '',
                          style: itemInfoTheme.textTheme.bodyMedium.copyWith(
                      ...
                      Text("${item.description ?? ''}",
                          style: itemInfoTheme.textTheme.bodyMedium),
                    ]),
              ),
            ],
          );
  ...
  static Widget _getNameAndPrice(BuildContext context, Item item) {
    TextStyle nameStyle = Theme.of(context).textTheme.bodyMedium;
